...
(function($, window, document, undefined) {
	...
	Grid.statics = {
		toolRowTmpl : '<div class="table-toolbar"><div class="row">'
				+ '<div ele-type="tools" class="col-md-6"><div class="btn-group"></div></div>'
				+ '<div ele-type="dropdowns" class="col-md-6"></div>'
				+ '</div></div>',
		dropdownTmpl : '<div class="btn-group pull-right"><button class="btn dropdown-toggle" data-toggle="dropdown" aria-expanded="false">${text_}<i class="fa fa-angle-down"></i></button>'
				+ '<ul class="dropdown-menu pull-right"></ul></div>',
	...
	Grid.prototype = {
		...
		_renderTool : function() {
			...
			if (this._dropdowns != undefined) {
				...
				toolRow.find("[ele-type='dropdowns']").append(dropdownBtn);
