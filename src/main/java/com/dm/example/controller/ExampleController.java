...
@Controller @RequestMapping("/example") public class ExampleController extends DefaultController {
    ...
    @RequestMapping("/list") public ModelAndView list(ModelAndView model,
        ...
        try {
            ...
            model.addObject("examples",
                exampleService.listByPage(searchEntity, thispage, pagesize, orders));
    ...
    @RequestMapping("/save") public ModelAndView save(ModelAndView model, ExampleEntity entity) {
        try {
            ExampleEntity ee = new ExampleEntity();
            if (entity.getId() != null) {
                ee = exampleService.findById(entity.getId());
                ee.setName(entity.getName());
                ee.setUpdateTime(DateUtil.formatDate(new Date(), "yyyy-MM-dd HH:mm:ss"));
