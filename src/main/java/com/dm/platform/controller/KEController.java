...
public class KEController {
	...
	public void file_upload(
			...
			throws Exception {
		try {
			String savePath = ConfigUtil.getConfigContent("dm","uploadPath")
					+ "/"
					+ UserAccountUtil.getInstance().getCurrentUserId()
					+ "/";
			// 文件保存目录URL
			String saveUrl = ConfigUtil.getConfigContent("dm",
					"uploadUrl")
					+ "/"
					+ UserAccountUtil.getInstance().getCurrentUserId()
					+ "/";
	...
	public void file_manager(HttpServletRequest request,
		...
		String rootPath = ConfigUtil.getConfigContent("dm",
				...
				+ "/" + UserAccountUtil.getInstance().getCurrentUserId() + "/";
		// 文件保存目录URL
		String rootUrl = ConfigUtil.getConfigContent("dm","uploadUrl")
				+ "/"
				+ UserAccountUtil.getInstance().getCurrentUserId() + "/";
		// 图片扩展名
